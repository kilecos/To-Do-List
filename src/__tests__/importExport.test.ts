...
describe("validerDonneesImport", () => {
    it("Retourne false si les donnees ne sont pas un objet", () => {
        expect(validerDonneesImport("une string")).toBe(false);
    });
    it("Retourne false si les données sont null", () => {
        expect(validerDonneesImport(null)).toBe(false);
    });
    it("Retourne false si les données importées ne sont pas un tableau", () => {
